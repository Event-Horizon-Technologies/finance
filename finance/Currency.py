...
class Currency(Asset):
    def __init__(
        self, symbol, timeframe="1DAY", start_date=None, end_date=None, limit=100
    ):
        self.limit = limit
    ...
    def get_ohlcv(self) -> None:
        json = CoinAPI.get_ohlcv(
            self.symbol, self.timeframe, self.start_date, self.end_date, self.limit
        )
