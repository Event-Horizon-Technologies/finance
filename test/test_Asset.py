...
class TestAsset(TestBaseClass):
    def __test_asset(self, symbol, timeframe, start_date_str, end_date_str):
        start_date = np.datetime64(start_date_str, Utils.DATETIME_TYPE)
        end_date = np.datetime64(end_date_str, Utils.DATETIME_TYPE)
    ...
    def test_btc_1d(self):
        self.__test_asset(symbol="BTC-USD", timeframe="1d", start_date_str="2014-09-17", end_date_str="2022-09-06")
    ...
    def test_spy_1d(self):
        self.__test_asset(symbol="SPY", timeframe="1d", start_date_str="1993-01-29", end_date_str="2022-09-06")
